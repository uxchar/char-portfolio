...
- Wire frames: Two group members, myself included, created wire frames to prototype the app's design and structure.
...
Below is the initial wire frame by team member, Natalya Naser. My wire frame
...
When designing my wire frame, I asked myself, what if someone has to go to
