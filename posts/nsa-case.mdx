...
pageTitle: Empowering Women To Feel Safe and Secure After Dark
...
This project was a valuable learning experience in that we used the Lean UX canvas for the first, which really helped set a solid foundation for us. Designing a complete product is difficult in that it requires the ability move quickly and adapt to new information. Add the demands of each team member also working full time and having other obligations, this was a project that really challenged us as a team. Not sure where it will go from here, but it will be fun to see if we can possibly create something that may one day make late night traveling a safer activity to take part in.
